...
const { containsUser, addUser, getUser,updateUser, addGoogleUser } = require('../mongo/dao/UserDAO');
 ...
 * @param {Response} res 
 */
async function addGoogleUserEndpoint(req,res)
{
    ...
    {   //If the email isn't speciefed or invalid email.
        ...
        {   
            ...
            {
                result.success=false;
                result.message="Name must have minimum length of 3."   
            }
            else{
...
module.exports={addUserEndpoint,getUserEndpoint,updateUserEndpoint,addGoogleUserEndpoint};